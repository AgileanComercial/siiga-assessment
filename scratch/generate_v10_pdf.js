...
// Uso: SCENARIO=baixo node scratch/generate_v9_pdf.js
...
const OUT_NAMES = {
  baixo: 'SIIGA_Assessment_PROTOTIPO_V10_baixo_2026-08-25.pdf',
  alto: 'SIIGA_Assessment_PROTOTIPO_V10_alto_2026-08-25.pdf',
  misto: 'SIIGA_Assessment_PROTOTIPO_V10_2026-08-25.pdf'
};
...
server.listen(8099, async () => {
  console.log('Static server on http://localhost:8099, SCENARIO=' + SCENARIO);
